...
<div class="tab-pane container active" id="bloodcenters">
<form action="file/bloodcentersReg.php" method="post" enctype="multipart/form-data">
  <input type="text" name="bcname" placeholder="bloodcenter Name" class="form-control mb-3" required>
  <input type="text" name="bccity" placeholder="bloodcenter City" class="form-control mb-3" required>
  <input type="tel" name="bcphone" placeholder="bloodcenter Phone Number" class="form-control mb-3" required pattern="[0,6-9]{1}[0-9]{9,11}" title="Password must have start from 0,6,7,8 or 9 and must have 10 to 12 digit">
  <input type="email" name="bcemail" placeholder="bloodcenter Email" class="form-control mb-3" required>
  <input type="password" name="bcpassword" placeholder="bloodcenter Password" class="form-control mb-3" required minlength="6">
  <input type="submit" name="bcregister" value="Register" class="btn btn-primary btn-block mb-4">
</form>
</div>
