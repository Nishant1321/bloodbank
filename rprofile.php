				...
				<div class="card">
					...
					<div class="card-body">
					   <form action="file/updateprofile.php" method="post">
						...
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Receiver upload</label>
						<input type="text" name="rupload" value="<?php echo $row['rupload']; ?>" class="form-control mb-3">
